"""
CashFlowService测试用例
测试现金流量表服务的完整业务逻辑，包括数据获取、过滤和字段选择
...
class TestCashFlowService:
        ...
        return [
            {
                ...
                "basic_eps": 15.33,
                "diluted_eps": 15.33,
                "net_cashflows_act": 120714458386.98,
                "revenue": 120714458386.98,
                "net_cashflows_inv_act": 19223784414.08,
            ...
            },
            {
                ...
                "basic_eps": 12.85,
                "diluted_eps": 12.85,
                "net_cashflows_act": 81931724607.68,
                "revenue": 81931724607.68,
                "net_cashflows_inv_act": 15746684414.08,
    ...
    async def test_get_cashflow_data_field_selection(
        ...
        # 验证字段值正确
        assert response.data[0]["net_cashflows_act"] == 120714458386.98
        assert response.data[0]["net_cashflows_inv_act"] == 19223784414.08
    ...
    async def test_get_cashflow_data_with_report_type(
        ...
        request = CashFlowRequest(
            ts_code="600519.SH",
            fields=["end_date", "net_cashflows_act", "report_type"],
            report_type="1",
        )
            ...
            large_data.append(
                {
                    ...
                    "net_cashflows_inv_act": 100000000.0 + i * 100000,
