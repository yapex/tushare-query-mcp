"""
BalanceService测试用例
测试资产负债表服务的完整业务逻辑，包括数据获取、过滤和字段选择
...
class TestBalanceService:
        ...
        return [
            {
                ...
                "basic_eps": 15.33,
                "diluted_eps": 15.33,
                "total_assets": 120714458386.98,
                "revenue": 120714458386.98,
                "total_equity": 19223784414.08,
            ...
            },
            {
                ...
                "basic_eps": 12.85,
                "diluted_eps": 12.85,
                "total_assets": 81931724607.68,
                "revenue": 81931724607.68,
                "total_equity": 15746684414.08,
    ...
    def sample_request(self):
        ...
        return BalanceRequest(
            ts_code="600519.SH",
            fields=["end_date", "total_assets", "total_equity"],
            start_date="20240101",
            end_date="20241231",
        )
    ...
    async def test_get_balance_data_field_selection(
        ...
        # 验证字段值正确
        assert response.data[0]["total_assets"] == 120714458386.98
        assert response.data[0]["total_equity"] == 19223784414.08
    ...
    async def test_get_balance_data_with_report_type(
        ...
        request = BalanceRequest(
            ts_code="600519.SH",
            fields=["end_date", "total_assets", "report_type"],
            report_type="1",
        )
            ...
            large_data.append(
                {
                    ...
                    "total_equity": 100000000.0 + i * 100000,
